...
/*
static struct platform_device lcdc_panel_ili9338_device = {
...
static int msm_fb_detect_panel(const char *name)
{
	...
	if (machine_is_msm7x25_ffa() || machine_is_msm7x27_ffa()) {
		//if (!strcmp(name, "lcdc_ili9338_rgb"))
...
struct atmel_i2c_platform_data mxt224_ts_data[] = {
{
	...
	.config_T9 = {131, 0, 0, 14, 11, 1, 33, 50, 3, 3, 10, 6, 3, 0x30, 2, 30, 30, 30,0x3f,1,239,0,0, 5, 0, 5, 0x40,0,0,0,18}, // setting [14] to 5 enables 5 pt multitouch, needs to be done for each controller version - netarchy
	.config_T18 = {0, 0},
...
#ifndef SND_SPKR_PA
	#define SND_SPKR_PA 23
#endif
static uint32_t msm_snd_spkr_pa_gpio_table[] = {
	GPIO_CFG(SND_SPKR_PA, 0, GPIO_OUTPUT, GPIO_PULL_DOWN, GPIO_2MA)
};
...
//<<<<<<<<<<<<<<<<<<<<<<<end<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<
	...
	bt_power_init();
	config_gpio_table(msm_snd_spkr_pa_gpio_table,ARRAY_SIZE(msm_snd_spkr_pa_gpio_table));
