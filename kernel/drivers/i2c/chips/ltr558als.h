...
#define LTR558_IOCTL_PS_DISABLE             _IOW(LTR558_IOCTL_MAGIC, 6, char *)
#define LTR558_IOCTL_ALS_DISABLE            _IOW(LTR558_IOCTL_MAGIC, 7, char *)
