...
static int msm_pmic_led_early_suspend(struct platform_device *dev,
		pm_message_t state);
static int msm_pmic_led_early_resume(struct platform_device *dev);
...
#ifdef CONFIG_HAS_EARLYSUSPEND
        early_suspend.suspend=msm_pmic_led_early_suspend;
	early_suspend.resume=msm_pmic_led_early_resume;
